...
\end{figure}
\footnotetext{Source: \url{http://en.wikipedia.org/wiki/File:MVC-Process.svg} \& \url{http://blogs.technet.com/b/student/archive/2013/04/15/design-style-programming-xaml-amp-mvvm-continued.aspx}}  
...
There are some language features that can lower the complexity of a program and ease the development process. This special features usually come from the standard library or each programming language. A very helpful feature are Lambdas, or anonymous functions, and Closures\marginpar{This terms are defined in the Appendix section}. Lambdas can help reduce the amount of code written, but can increase complexity and Closures provide better flexibility to your code.
