...
%************************** 
\section{BlackBerry}
The Blackberry OS is a proprietary mobile operating system developed by BlackBerry Ltd\marginpar{BlackBerry Ltd was until recently known as RIM (Research In Motion)} exclusively for its line of BlackBerry devices.
...
After countless delays and cancellations\footnote{\url{http://www.mobiletechworld.com/2009/09/24/steve-ballmer-wishes-windows-mobile-7-had-already-launched-but-they-screwed-up/}} Windows Phone finally launched on October \nth{10}, 2010, bringing many new features and changes. The biggest one was a completely redesigned UI called Metro\marginpar{The Metro UI Design also exists on Windows 8}, using tiles to organise content on screen.  
\begin{quotation}
